                    ...
                    _ = function(i, n, a) {
                        if ("path" == i.type) {
                            ...
                            if ("open" == x ? (k += 2, B += 2, C += 2, b = 1, _ = a ? 4 : 1, w = {
                                ...
                                }), T.appendChild(E), o.defs.appendChild(T), g[A] = 1),
                                v(E, w);
                            ...
                            if (a[e](d)) {
                                ...
                                case "fill-opacity":
                                    if (u.gradient) {
                                        ...
                                        P && (F = P.getElementsByTagName("stop"), v(F[F.length - 1], {
                                            "stop-opacity": g
                                        }));
                                        break
                                    }
